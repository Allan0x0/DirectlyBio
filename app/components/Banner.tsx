...
export function Banner(props: Props) {
  ...
  return (
    <div
      className={twMerge(
        'flex flex-col justify-center items-center py-6 mr-[10rem] relative shrink-0',
        className,
      )}
      {...rest}
    >
      ...
      <Phone className="z-10 pb-4 bg-gradient-to-b from-stone-400 via-white to-stone-400">
        ...
        <div className="grow" />
        <div className="flex flex-col items-stretch gap-4 px-6">
          <div className="flex flex-row items-center gap-2">
            <div className="grow" />
            <div className="flex flex-col justify-center items-center p-1 rounded-full bg-white/10">
              <IconChevronUp className="text-stone-800" />
            </div>
          </div>
          <FlatCard className="flex flex-row items-center gap-2 py-3">
            <span className="text-xs">Online Presense</span>
            <div className="grow" />
          </FlatCard>
          <FlatCard className="flex flex-row items-center gap-2 py-3">
            <span className="text-xs">Online Presense</span>
...
function FlatCard(props: FlatCardProps) {
  ...
  return (
    <div
      className={twMerge(
        'rounded-lg bg-white px-3 py-2 flex flex-col items-start shadow-lg',
        className,
      )}
      {...rest}
    >
